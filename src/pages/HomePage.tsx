...
const savingsCalculator = [
  {
    ...
    activities: [
      ...
      "Practicing important facial expressions",
    ],
  },
  {
  ...
  },
  {
    ...
    cost: 85000,
    activities: [
      "Sending birthday reminder emails",
      "Organizing mandatory fun",
      "Mediating coffee machine disputes",
    ],
  },
  {
    ...
    cost: 95000,
    activities: [
      "Creating buzzword bingo cards",
      "Taking Instagram-worthy office photos",
  ...
  },
  {
    ...
    cost: 110000,
    activities: [
      "Making Excel sheets about other Excel sheets",
      "Predicting unpredictable markets",
      "Expense report archaeology",
    ],
  },
  {
...
const successStories = [
  {
    ...
    quote:
      "Thanks to AI replacing me, I finally had time to pursue my dream of catching waves instead of VLOOKUP errors!",
    savings: "$85,000/year",
  ...
  },
  {
    ...
    quote:
      "No more scheduling conflicts! Now I only coordinate the perfect taco-to-salsa ratio.",
    savings: "$65,000/year",
  ...
  },
  {
    ...
    quote:
      "Instead of managing human resources, I now commune with nature's most beautiful resources.",
    savings: "$95,000/year",
  ...
  },
  {
    ...
    quote:
      "Traded my Gantt charts for yoga mats. Namaste away from deadlines forever!",
  ...
  },
  {
    ...
    quote:
      "Finally selling something authentic - the beauty of doing absolutely nothing.",
...
const features = [
  {
    ...
    description:
      "AI doesn't complain about Mondays, need coffee breaks, or have existential crises during meetings. It just works, like that one colleague you had before they discovered TikTok.",
  ...
  },
  {
    ...
    description:
      "While humans dream of beach selfies, our AI works 24/7/365. No PTO, sick days, or 'my dog ate my laptop' excuses. Even on holidays, because AI doesn't have in-laws to visit.",
    icon: ClockIcon,
  ...
  },
  {
    ...
    description:
      "Say goodbye to office politics, water cooler gossip, and passive-aggressive sticky notes in the break room. Our AI won't steal your lunch from the fridge or organize mandatory fun events.",
    icon: UserGroupIcon,
  ...
  },
  {
    ...
    description:
      "Our AI never shows up late because of 'traffic,' mysterious doctor appointments, or that suspicious third cousin's wedding. It's always punctual, even during solar eclipses.",
    icon: ChartBarIcon,
    highlight: "100% Attendance",
    stats: [
      "100% punctuality",
      "No traffic excuses",
      "No mysterious appointments",
    ],
  },
  {
    name: "No Performance Reviews",
    description:
      "Skip those awkward annual reviews where everyone pretends to be passionate about synergy and corporate values. Our AI's only passion is getting the job done (and maybe binary).",
  ...
  },
  {
    ...
    description:
      "Save 90% on costs and 100% on birthday cakes, farewell parties, and team-building exercises. No more expensive coffee machines or ergonomic chair requests.",
    icon: CurrencyDollarIcon,
    highlight: "90% Cost Reduction",
    stats: [
      "90% cost savings",
      "0 equipment requests",
      "No party budget needed",
    ],
  },
  {
    name: "Zero Learning Curve",
    description:
      "Unlike humans who need constant training and still click 'Reply All' by mistake, our AI comes pre-loaded with everything it needs to know. No awkward onboarding required.",
    icon: SparklesIcon,
  ...
  },
  {
    ...
    description:
      "No more emotional rollercoasters or office romances gone wrong. Our AI maintains perfect emotional stability, even during mercury retrograde.",
    icon: HeartIcon,
  ...
  },
  {
    ...
    description:
      "While humans need sleep, our AI operates across all time zones simultaneously. It's like having a global workforce, minus the complicated visa paperwork.",
    icon: GlobeAltIcon,
  ...
  },
  {
    ...
    description:
      "While humans need 'work-life balance', our AI scales infinitely. No more hiring sprees or onboarding nightmares. Just pure, unlimited productivity.",
  ...
  },
  {
    ...
    description:
      "Forget two-week notices and lengthy handovers. Our AI deploys faster than you can say 'where's the coffee machine?'",
    icon: BoltIcon,
  ...
  },
  {
    name: "Zero HR Issues",
    description:
      "No more sensitivity training or workplace conflict resolution. Our AI doesn't care about office politics or who took the last donut.",
    icon: HandRaisedIcon,
    highlight: "Drama Free",
...
const funFactsRotator = [
  {
    stat: "1,000,000+",
    label: "Hours of Meetings Eliminated",
    icon: ClockIcon,
  },
...
const aiCapabilities = [
  {
    ...
    description:
      "Our AI processes information at quantum speeds, making human thought look like dial-up internet",
    icon: LightBulbIcon,
    metrics: [
      "1B operations/second",
      "Zero cognitive delays",
      "Instant decisions",
    ],
  },
  {
    ...
    description:
      "Unlike humans who forget their passwords, our AI remembers everything, forever",
    icon: BeakerIcon,
  ...
  },
  {
    ...
    description:
      "No mood swings, no Monday blues, just pure logical excellence 24/7",
    icon: HeartIcon,
  ...
  },
  {
    ...
    description:
      "While humans think in 3D, our AI operates in multiple dimensions of problem-solving",
    icon: BriefcaseIcon,
...
const HomePage: React.FC = () => {
  ...
  const calculatorInView = useInView(calculatorRef, {
    once: true,
    margin: "-100px",
  });
  ...
  const calculateTotalSavings = useCallback(() => {
    const totalSalaries =
      calculatorState.employeeCount * calculatorState.averageSalary;
    const coffeeCost =
      calculatorState.employeeCount *
      calculatorState.coffeeConsumption *
      5 *
      252; // $5 per coffee, 252 work days
    const meetingCost =
      calculatorState.meetingHours *
      52 *
      calculatorState.employeeCount *
      (calculatorState.averageSalary / 2080); // 2080 work hours per year
    const dramaCost =
      calculatorState.dramaLevel * 1000 * calculatorState.employeeCount; // $1000 per drama level per employee
    ...
    return {
      ...
      timeReclaimed:
        calculatorState.meetingHours * 52 * calculatorState.employeeCount,
            ...
            >
              ...
              >
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Let's face it - nobody actually enjoys TPS reports, endless
                  meetings about meetings, or pretending to be busy when the
                  boss walks by. Give your employees the gift of freedom and let
                  AI handle the mundane 9-to-5 grind while they pursue their
                  dreams of becoming professional dog photographers.
                </p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    See How AI Never Asks for Raises{" "}
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleSliderChange("meetingHours", parseInt(e.target.value))
                  }
                  className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                />
                <div className="text-sm text-gray-600 mt-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleSliderChange("dramaLevel", parseInt(e.target.value))
                  }
                  className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                />
                <div className="text-sm text-gray-600 mt-2">
                  Level {calculatorState.dramaLevel} -{" "}
                  {calculatorState.dramaLevel < 4
                    ? "Mild Gossip"
                    : calculatorState.dramaLevel < 7
                    ? "Reality TV Worthy"
                    : "Full Soap Opera"}
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="mt-2 text-sm text-green-600">
                    That's{" "}
                    {calculateTotalSavings().coffeeEquivalent.toLocaleString()}{" "}
                    artisanal coffees!
                  </div>
                </motion.div>
                  ...
                  <div className="flex gap-4 mt-2">
                    <div className="text-blue-800">
                      <span className="text-2xl font-bold">
                        {calculateTotalSavings().vacationHomes}
                      </span>
                      <div className="text-sm">Vacation Homes</div>
                    </div>
                    <div className="text-blue-800">
                      <span className="text-2xl font-bold">
                        {calculateTotalSavings().privateJets}
                      </span>
                      <div className="text-sm">Private Jets</div>
                    </div>
                    <div className="text-blue-800">
                      <span className="text-2xl font-bold">
                        {calculateTotalSavings().yachts}
                      </span>
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-purple-800">
                    {calculateTotalSavings().timeReclaimed.toLocaleString()}{" "}
                    hours
                  </div>
                  <div className="mt-2 text-sm text-purple-600">
                    That's{" "}
                    {Math.floor(calculateTotalSavings().timeReclaimed / 24)}{" "}
                    days of freedom!
                  </div>
                </motion.div>
        ...
        <div className="py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {Object.entries(calculateDetailedSavings()).map(
                ([key, value]) => (
                  <motion.div
                    key={key}
                    className="bg-white rounded-xl shadow-lg p-6"
